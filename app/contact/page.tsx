...
export const metadata: Metadata = {
  ...
  description:
    "Contact Skylight Travel in Al Sajaa, Sharjah, UAE. Speak with our travel consultants via WhatsApp +971 58 273 8508, call, or email skylighttourismllc@gmail.com.",
