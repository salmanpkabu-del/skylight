            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-white/70">
                <div className="flex flex-col gap-4">
                  ...
                  <a href="mailto:skylighttourismllc@gmail.com" className="flex items-center gap-3 hover:text-brand-green transition-colors w-fit">
                    <Mail size={18} />
                    <span className="text-sm sm:text-base">skylighttourismllc@gmail.com</span>
                  </a>
